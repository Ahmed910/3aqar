...
class ContractRequest extends ApiMasterRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'address_image'=>'required|image|mimes:png,jpg,jpeg,gif',
            'identity_number_image_for_citizen'=>'required|image|mimes:png,jpg,jpeg,gif',
            'national_address_for_citizen'=>'required|image|mimes:png,jpg,jpeg,gif',
            'building_date'=>'required|date_format:Y-m-d',
            'aqar_number'=>'required|integer',
