                    ...
                    <div class="tab-content pt-1">
                        <div class="tab-pane active" id="main-fill" role="tabpanel" aria-labelledby="main-tab-fill">
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                <div class="row">
                                    <label class="font-medium-1 col-md-2">{!! trans('dashboard.general.whatsapps') !!}</label>
                                    <div class="col-md-10">
                                        {!! Form::text('whatsapps', setting('whatsapps') ? setting('whatsapps'):old('whatsapps'), ['class'=>'form-control tagsinput-custom-tag-class','placeholder'=>trans('dashboard.setting.whatsapps')]) !!}
                                    </div>
                                </div>
                            </div>
